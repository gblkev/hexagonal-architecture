package com.gebel.hexagonalarchitecture.inbound._test;
...
import test.com.gebel.hexagonalarchitecture.sandbox.container.TestContainers;
...
public abstract class AbstractIntegrationTest {
	...
	private static final List<String> KAFKA_TOPICS = List.of("hexagonalarchitecture.create-color");
	...
	private static void startContainers() throws Exception {
		...
		TEST_CONTAINERS.initZookeeperKafkaContainersWithRandomPort(KAFKA_TOPICS);
	...
	private static void setDynamicConfigurationProperties(DynamicPropertyRegistry registry) throws IOException {
		...
		registry.add("spring.kafka.bootstrap-servers", () -> TEST_CONTAINERS.getZookeeperKafkaTestContainers().getContainer().getBootstrapServers());
	}
