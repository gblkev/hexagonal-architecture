...
import test.com.gebel.hexagonalarchitecture.sandbox.container._test.AbstractIntegrationTest;

@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@TestPropertySource("classpath:application-test.properties")
class TestContainersZookeeperKafkaIT extends AbstractIntegrationTest {
	
	private static final String TOPIC = "hexagonalarchitecture.create-color";
	private static final String GROUP_ID = "hexagonalarchitecture";
